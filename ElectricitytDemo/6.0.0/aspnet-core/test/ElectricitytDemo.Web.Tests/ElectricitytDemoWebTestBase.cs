...
using ElectricitytDemo.Models.TokenAuth;
...
{
    public abstract class ElectricitytDemoWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static ElectricitytDemoWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(ElectricitytDemoWebMvcModule).Assembly.FullName);
        }
        ...
        protected void UsingDbContext(Action<ElectricitytDemoDbContext> action)
        {
            using (var context = IocManager.Resolve<ElectricitytDemoDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected T UsingDbContext<T>(Func<ElectricitytDemoDbContext, T> func)
        {
            T result;
        ...
        protected async Task UsingDbContextAsync(Func<ElectricitytDemoDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<ElectricitytDemoDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<ElectricitytDemoDbContext, Task<T>> func)
        {
            T result;
